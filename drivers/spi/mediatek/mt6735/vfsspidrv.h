...
#define VFSSPI_DRDY_PIN     GPIO_FIGERPRINT_INT
#define VFSSPI_SLEEP_PIN    GPIO_FIGERPRINT_RST
#define VFSSPI_CS_PIN       GPIO_SPI_CS_PIN
#define DO_CHIP_SELECT      0
#define DRDY_ACTIVE_STATUS  1   //1
#define BITS_PER_WORD       8  //8
#define DRDY_IRQ_FLAG       EINTF_TRIGGER_RISING // EINTF_TRIGGER_FALLING   //EINTF_TRIGGER_RISING   //IRQF_TRIGGER_RISING
#define DEFAULT_BUFFER_SIZE (4096 * 6)   //(4096 * 6)
...
#define VFSSPI_IOCTL_GET_SENSOR_ORIENTATION       _IO(VFSSPI_IOCTL_MAGIC,   18)
