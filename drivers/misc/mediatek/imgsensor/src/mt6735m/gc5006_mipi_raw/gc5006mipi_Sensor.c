...
#define PFX "GC5006_camera_sensor"
/****************************   Modify end    *******************************************/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		*sensor_id = 0xFFFFFFFF;
			...
			*sensor_id = GC5006_MIPI_SENSOR_ID;
			LOG_INF("vendor_id:microkore\n");	
		}
		#ifdef CONFIG_HW_INFO
	    strcpy(main_camera.vendor,"MicroKore");
...
UINT32 GC5006_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
