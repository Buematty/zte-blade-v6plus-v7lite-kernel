...
#include "st55ayamipiraw_Sensor.h"

#define PFX "ST55AYA_camera_sensor"

#define LOG_1 LOG_INF("ST55AYA,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
	...
	.hs_video = {
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width =640, //1920,
		.grabwindow_height =480,// 1080,
		.mipi_data_lp2hs_settle_dc = 65,//unit , ns
		.max_framerate = 1200,
	},
	.slim_video = {
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {				
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
	                        //mtk_sensorinfo_set_front_sensor_id(ST55AYA_SENSOR_ID);
				return ERROR_NONE;
			}
...
UINT32 ST55AYA_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	ST55AYA_MIPI_RAW_SensorInit	*/
