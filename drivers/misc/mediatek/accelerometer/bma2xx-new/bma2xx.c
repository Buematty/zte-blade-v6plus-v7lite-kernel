...
static int bma2xx_init_client(struct i2c_client *client, int reset_cali)
{
	...
	res = BMA2XX_SetPowerMode(client, enable_status);
	if(res != BMA2XX_SUCCESS)
		return res;
...
static long bma2xx_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
...
exit_register_control_path:
	bma2xx_delete_attr(&bma2xx_init_info.platform_diver_addr->driver);
...
static const struct of_device_id accel_of_match[] = {
	{.compatible = "mediatek,gsensor_bma2xx"},
	{},
};
#endif
