...
struct acc_hw kxtj2_accel_cust;
static struct acc_hw *hw = &kxtj2_accel_cust;

/* For  driver get cust info */
struct acc_hw *get_cust_acc(void)
{
	return &kxtj2_accel_cust;
}
...
static ssize_t show_sensordata_value(struct device_driver *ddri, char *buf)
{
	...
	if(NULL == client)
	{
		...
		return 0;
            ...
            printk("+++gsensorshow_sensordata_value\n");
...
//       unsigned long arg)
static long kxtj2_1009_ioctl(struct file *file, unsigned int cmd,unsigned long arg)
{
...
static struct file_operations kxtj2_1009_fops = {
	...
	.unlocked_ioctl = kxtj2_1009_ioctl,//kxtj2_1009_unlocked_ioctl,
	#ifdef CONFIG_COMPAT
