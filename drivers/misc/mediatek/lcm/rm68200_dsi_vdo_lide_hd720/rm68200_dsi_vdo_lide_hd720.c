...
static unsigned int lcm_compare_id(void)
{
    ...
    {        
        ...
        printk("%s, lide rm68200 , pin_lcd_id0= %d ,lcd vendor id is 0x%x\n", __func__, pin_lcd_id0,lcd_id);
        
        return (0x10 != lcd_id)?1 :0;	
...
{
    #ifdef BUILD_LK
    printf("lcm_init:lide rm68200 \n");
    #else
    printk("lcm_init:lide rm68200 \n");
    #endif
    SET_RESET_PIN(1);
    MDELAY(10);//5
    SET_RESET_PIN(0);
...
{
#ifdef BUILD_LK
	dprintf(0,"%s,lklide rm68200 backlight: level = %d\n", __func__, level);
#else
	printk("%s, kernel lide rm68200 backlight: level = %d\n", __func__, level);
#endif
...
LCM_DRIVER rm68200_dsi_vdo_lide_hd720_lcm_drv = 
{
	.name			= "rm68200",
