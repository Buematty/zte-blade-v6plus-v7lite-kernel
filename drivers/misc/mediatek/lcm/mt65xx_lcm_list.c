...
#if defined(ILI9806E_DSI_VDO_FWVGA_2)
	&ili9806e_2_fwvga_dsi_vdo_lcm_drv,
#endif
#if defined(FL10802_DSI_WVGA)
    &fl10802_wvga_dsi_vdo_lcm_drv,
#endif	
...
#endif
//zhangjian add for P635A32
#if defined(ILI9881C_DSI_VDO_DIJING_HD720)
	&ili9881c_dsi_vdo_dijing_hd720_lcm_drv,
#endif
#if defined(ILI9881C_DSI_VDO_YASHI_HD720)
	&ili9881c_dsi_vdo_yashi_hd720_lcm_drv,
#endif
#if defined(RM68200_DSI_VDO_LIDE_HD720)
    &rm68200_dsi_vdo_lide_hd720_lcm_drv,
#endif
#if defined(HX8392A_720P_LD_DSI_VDO)
	&hx8392a_720p_ld_dsi_vdo_drv,
#endif
//yangchaofeng add for A31
#if defined(SUMSING_S6E8_HD_VDO_DSI)
	&s6e8aa4_dsi_cmd_lcm_drv,
#endif
#endif
};
