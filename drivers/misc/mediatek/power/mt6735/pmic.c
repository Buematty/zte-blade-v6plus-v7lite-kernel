...
{
	wake_lock_timeout(&usb_wakelock, 5* HZ);	//unlock after 5*HZ
	printk("[chrdet_int_handler]CHRDET status = %d....\n",
...
/*#if defined(CONFIG_MTK_FPGA)*/
	...
	wake_lock_init(&usb_wakelock, WAKE_LOCK_SUSPEND, "usb wakelock");
	return 0;
}
