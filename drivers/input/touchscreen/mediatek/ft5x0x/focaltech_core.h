...
#else
#define KEY_GESTURE_DOUBLE_TAP  214
#define KEY_GESTURE_CHAR_C   219
#define KEY_GESTURE_CHAR_E   220
#define KEY_GESTURE_CHAR_M   221
#define KEY_GESTURE_LEFT     222
#define KEY_GESTURE_RIGHT	 223
#define KEY_GESTURE_CHAR_S   227
#define KEY_GESTURE_CHAR_W   228
#define KEY_GESTURE_CHAR_O   230
#endif
//add end
/*******************************************************************************
...
//zhangjian add
extern int fts_create_wake_gesture_sysfs(struct i2c_client *client);
extern int fts_5x46_read_para_from_bootloader(struct i2c_client *client, u8 *pVendorID, u8 *pChipID);
extern int fts_remove_wake_gesture_sysfs(struct i2c_client *client);
extern void fts_get_upgrade_array_CTPM_FW(void);
extern bool enable_wakeup_gesture;
extern u8 lcd_read_vendor_id;
//add end
